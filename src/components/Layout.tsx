...
function Header() {
  ...
  return (
    <header
      className={cx(
        'sticky top-0 z-50 flex flex-none flex-wrap items-center justify-between bg-[var(--surface)] px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 sm:px-6 lg:px-8 dark:shadow-none',
        isScrolled
