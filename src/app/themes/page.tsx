    ...
    <div className={className}>
      <div className="rounded-xl border border-black/5 bg-[var(--surface)] p-6 shadow-sm ring-1 ring-black/5 dark:ring-white/5">
        ...
        <Prose className="mt-3">
          ...
          <p>
            <button
              className="mt-2 rounded-md bg-[var(--surface-muted)] px-3 py-1.5 text-sm text-[var(--fg)] ring-1 ring-black/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface)] dark:ring-white/10"
            >
              フォーカスリングを確認
            </button>
          </p>
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 text-slate-600 dark:text-slate-400">
        Rotom / Lavender / Steel の3案を横並びで比較できます。
      </p>
      <div className="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        <SampleCard title="Rotom Cyan × Navy" className="theme-rotom" />
